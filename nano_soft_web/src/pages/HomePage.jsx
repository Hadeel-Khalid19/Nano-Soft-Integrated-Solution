...
const HomePage = ({ onNavigate }) => {
  ...
  return (
    <div className={`home-container ${drawerOpen ? 'drawer-open' : ''}`} dir="rtl">
      {/* Background Waves */}
      ...
      <header className="elegant-header">
        <div className="header-right">
          ...
          <h2 className="brand-title">نانو سوفت</h2>
        </div>
      ...
      {/* Bottom Navigation */}
      <nav className="elegant-bottom-nav">
      ...
      {/* Drawer Sidebar */}
      <aside className={`elegant-drawer ${drawerOpen ? 'open' : ''}`}>
        <div className="drawer-header">
          <div className="drawer-user">
            ...
            <div>
              <h3>مرحباً بك</h3>
              <p>مستخدم نانو سوفت</p>
            </div>
          </div>
          <button className="icon-btn close-btn" onClick={() => setDrawerOpen(false)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
          </button>
        </div>
        
        <ul className="drawer-menu">
          <li onClick={() => { setDrawerOpen(false); onNavigate('home'); }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            الرئيسية
          </li>
          <li onClick={() => { setDrawerOpen(false); onNavigate('profile'); }}>
